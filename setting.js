...
global.botname = 'INUMAKI Zʏɴxᴢᴏ' // Ini nama bot
global.bottz = '25767334893' // Ganti dengan nomor bot untuk mendapatkan code pairing 
global.packname = '25767334893' // wm sticker
global.author = `Date: ${moment.tz('Asia/Jakarta').format('DD/MM/YY')}\nCreator: Zʏɴxᴢᴏ \nBot: 0857-8903-4010` // wm sticker
global.prefa = ['','!','.',',','🐤','🗿']
global.versions = `${zynz}`
global.ownername = 'TOGE INUMAKI' // Ubah jadi nama lu
global.owner = ['25767334893'] // Jangan ubah no lu
